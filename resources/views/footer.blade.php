...
<!-- <footer>
	<div class="footer-slide-wrap">
		<div class="container">
			<div>
				<div class="footer-slide-name">
					Logo đối tác
				</div>
				<div class="footer-slide owl-carousel owl-theme">
					<div>
						<a href="">
							<img src="images/logo_yss-1.jpg" class="img-fluid">
						</a>
					</div>
					<div>
						<a href="">
			...
			<div class="row">
				<div class="d-none d-lg-block col-lg-2">
					<div class="footer-left">
						<div>
							<img src="images/img-ok.png" class="img-fluid">
						</div>
						<div style="padding-right: 20px;">
							<a href=""><img src="images/tải xuống.png" class="img-fluid"></a>
						</div>
						<div>
							<a href=""><img src="images/dathongbao.png" class="img-fluid"></a>
						</div>
					</div>
				</div>
				<div class="col-md-12 col-lg-6">
					<div class="footer-center">
						<div class="footer-center-title">
							<p>HỆ THỐNG CHI NHÁNH PHỤ TÙNG XE MÁY CHÍNH HIỆU THIÊN NHẪN</p>
							<p>Giờ làm việc: Thứ 2 - Chủ Nhật: 8h00 - 17h30</p> 
						</div>
						<div class="footer-center-member">
							<div>
								<span><a href="">PHÒNG TRƯNG BÀY - BÁN LẺ - LẮP RÁP - SỬA CHỮA - BẢO HÀNH HOÀNG VĂN THỤ</a></span>
								<span> (Miễn phí công lắp ráp)</span>
							</div>
							<div>
								<div class="row">
									<div class="col-sm-4">
										<img src="images/tel.png" style="padding-right: 5px;">028 3811 3161
									</div>
									<div class="col-sm-8">
										<div class="d-flex">
											<div>
												<img src="images/maps.png" style="height: 27px; padding-right: 5px;">
											</div>
											<div>
												<span>551 Hoàng Văn Thụ, P.4, Q.Tân Bình, HCM</span>
												<span style="color: #0000FF;">(gần Triển lãm Tân Bình) </span>
												<span style="font-style: italic; font-size: 13px;"><a href="">(Xem đường đi)</a></span>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="col-md-12 col-lg-4">
					<div class="footer-right">
						<div class="footer-right-1 d-flex mb-3">
							<div class="pr-2">
						...
						<div class="footer-right-1 d-flex mb-3">
							...
							<div>
								VPĐD: 34/27 Lữ Gia, P. 15, Q. 11, TP.HCM MST : 0303016168 - ĐKLĐ : 08/08/2003 - Tại Phòng Đăng Ký Kinh Doanh, Sở Kế Hoạch Và Đầu Tư TP. HCM
							</div>
						</div>
						<div class="footer-right-1 d-flex mb-3">
							<div class="pr-2">
							...
							<div>
								ĐT: Hotline - 094 3333 427 
								<br>Fax: 028 3864 7063
							</div>
						</div>
						<div class="footer-right-1 d-flex mb-3">
							<div class="pr-2">
							...
							<div>
								<a href="">admin@phutungchinhhieu.com</a>
							</div>
						</div>
						<div class="footer-right-1 d-flex mb-3">
							<div class="pr-2">
						...
						<div class="footer-right-1 d-flex mb-3">
							...
							<div>
								Sáng: 08h00 Chiều:13h00
							</div>
						</div>
						<div>
							<div id="fb-root"></div>
							<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v3.3"></script>
							<div class="fb-page" data-href="https://www.facebook.com/facebook" data-tabs="timeline" data-width="285" data-height="197" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/facebook" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/facebook">Facebook</a></blockquote></div>
						</div>
					</div>
				</div>
			</div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-12 col-12">
                <figure>
                    <img src="http://phutungchinhhieu.com/App_Themes/images/icon/img-ok.png" alt="">

                    <a href="#">
                        <img src="http://phutungchinhhieu.com/App_Themes/images/dathongbao.png" alt="">
                    </a>
                </figure>
            ...
            <!-- colum-2 -->
            <div class="col-lg-6 col-md-6 sol-sm-12 col-12 colum-2">

                <div class="title-big">
                    <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hi</h2>
                    <i>Giờ làm việc: Thứ 2 - Chủ Nhật: 8h00 - 17h30 </i>
                </div>

                <div class="exhibition-room">
                    <a href="#">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto consectetur adipisicing
                        elit. Hi <span>(Miễn phí công lắp ráp)</span></a>
                    <div class="tel d-flex ">
                        <p><i class="fas fa-phone"></i> 0967.700.545</p>
                        <div class="map-icon">
                            <p><i class="fas fa-map-marked-alt"></i> 551 Hoàng Văn Thụ, P.4, Q.Tân Bình, HCM</p>
                            <p><span>(gần Triển lãm Tân Bình)</span> (xem đường đi)</p>
                        </div>
                    </div>
                </div>
            ...
            <!-- colum-3 -->
            <div class="col-lg-4 col-md-4 col-sm-12 col-12 colum-3">
                <h2><i class="fas fa-flag"></i> Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore
                    corporis, </h2>

                <!-- address -->
                <div class="d-flex  address genaral mb-3">
                    <p> <i class="fas fa-home"></i></p>

                    <div class="content-text">
                        <p>VPĐD: 34/27 Lữ Gia, P. 15, Q. 11, TP.HCM</p>
                        <P>MST : 0303016168 - ĐKLĐ : 08/08/2003 - Tại Phòng Đăng
                            Ký Kinh Doanh, Sở Kế Hoạch Và Đầu Tư TP. HCM</P>
                    </div>
                ...
                <!-- hottline -->
                <div class="d-flex hottline genaral mb-3">
                    <p> <i class="fas fa-fax"></i></p>

                    <div class="content-text">
                        <p>ĐT: Hotline - 094 3333 427</p>
                        <P>Fax: 028 3864 7063</P>
                    </div>
                ...
                <!-- phu tung -->
                <div class="d-flex hottline phu-tung genaral mb-3">
                    <p> <i class="fas fa-coins"></i></p>

                    <div class="content-text">
                        <a href="#">phutungchinhhang.com</a>
                    </div>
                ...
                <div class="fanpage text-center">
                    <iframe
                        src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Ffacebook&tabs=timeline&width=340&height=150&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=false&appId"
